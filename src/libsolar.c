...
#define mDR (M_PI / 180.0f)
#define mK1 (15 * mDR * 1.0027379)
...
/*internal sealed class SunTimes
{
    ...
    /*private       double mDR = M_PI / 180;
    private const double mK1 = 15 * mDR * 1.0027379;*/

    private int mRiseTimeArr[2] = { 0, 0 };
    private int mSetTimeArr[2] = { 0, 0 };
    private double mRizeAzimuth = 0.0f;
    private double mSetAzimuth = 0.0f;

    private double mSunPositionInSkyArr[2] = { 0.0f, 0.0f };
    private double mRightAscentionArr[3] = { 0.0f, 0.0f, 0.0f };
    private double mDecensionArr[3] = { 0.0f, 0.0f, 0.0f };
    private double mVHzArr[3] = { 0.0f, 0.0f, 0.0f };
    ...
    /*private readonly SunTimes mInstance = new SunTimes();    // The singleton instance
